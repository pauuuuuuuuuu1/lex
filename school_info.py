...
class Schoolinfo:
    ...
    def __init__(self,root, show_main_app_callback):
        ...
        #title section
        title_lb1 = Label(bg_img,text="About School",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        std_b1.place(x=210,y=140,width=280,height=280)
        ...
        std_b1.place(x=212,y=552,width=280,height=45)
        ...
        det_b1.place(x=620,y=140,width=280,height=280)
        ...
        det_b1.place(x=622,y=552,width=280,height=45)
