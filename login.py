...
class Login:
    def __init__(self,root,show_main_app_callback):
        ...
        frame2.place(x=900, y=170, width=340, height=450)
        # hanggang dito
        ...
        get_str = Label(frame2,text="TEACHER",font=("times new roman",40,"bold"),fg="white",bg="#6A8CC9")
        get_str.place(x=40,y=40)
        ...
        loginbtn.place(x=33,y=410,width=270,height=35)
        ...
        loginbtn.place(x=33,y=330,width=120,height=25)

        return_button = tk.Button(self.root, text="Return to Main Page", command=show_main_app_callback, font=("verdana",12,"bold"),fg="white", bg="#002B53")
