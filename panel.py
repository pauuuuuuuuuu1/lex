...
class AdminPanel:
 ...
 # This part is image labels setting start 
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Admin Panel",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        return_button = Button(self.root, text="ACTIVITY LOGS", command=self.open_windows1,
                               font=("verdana", 12, "bold"), fg="white", bg="navyblue")
        ...
        left_table_frame.place(x=10,y=92,width=710,height=360)

        self.del_teacher_btn = Button(left_frame,command=self.teacher_delete_data, text="Delete", width=7, font=("verdana", 12, "bold"), fg="white", bg="navyblue", state=DISABLED)
        self.del_teacher_btn.place(x=565, y=490, width=155, height=40)
        

        self.teacher_search_entry = Entry(left_frame, font=("verdana", 11), bd=2, relief=GROOVE)
        self.teacher_search_entry.place(x=360, y=25, width=200, height=40)

        self.teacher_search_btn = Button(left_frame, text="Search", command=self.search_teacher_data, font=("verdana", 12, "bold"), fg="white", bg="navyblue")
        self.teacher_search_btn.place(x=565, y=25, width=155, height=40)
        ...
        showAll_btn.place(x=10, y=490, width=155, height=40)
        ...
        self.student_search_btn.place(x=565, y=25, width=155, height=40)
      ...
      #Table Frame 
        ...
        table_frame.place(x=10,y=92,width=710,height=360)

        self.del_student_btn = Button(right_frame, command=self.student_delete_data, text="Delete", width=7, font=("verdana", 12, "bold"), fg="white", bg="navyblue",state=DISABLED)
        self.del_student_btn.place(x=565, y=490, width=155, height=40)
        #scroll bar 
        ...
        self.student_table.bind("<ButtonRelease>",self.get_cursor1)
        self.fetch_data()
    ...
    def get_cursor1(self, event=""):
        ...
        self.var_std_id.set(data[0])
        self.del_student_btn['state'] = tk.NORMAL
    ...
    def open_windows1(self):
        ...
        self.app1 = LogViewerApp(self.window1, self.show_main_app)
