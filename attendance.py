...
class Attendance:
    ...
    def __init__(self,root,show_main_app_callback):
        ...
        # backgorund image 
        bg1=Image.open(r"Images_GUI\attpanel.jpg")
        ...
        main_frame.place(x=25,y=200,width=1500,height=610)
        ...
        return_button = tk.Button(self.root, text="BACK", command=show_main_app_callback, font=("verdana",12,"bold"),fg="white", bg="#003D60")
        ...
        search_button = Button(right_frame, text="Search", command=self.search_data,width=12,font=("verdana",12,"bold"),fg="white",bg="#003D60")
    ...
    #Update button
        ...
        del_btn=Button(btn_frame,command=self.update_data,text="Update",width=12,font=("verdana",12,"bold"),fg="white",bg="#003D60")
        del_btn.grid(row=2,column=1,padx=6,pady=10,sticky=W)
    #Update button
        del_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=12,font=("verdana",12,"bold"),fg="white",bg="#003D60")
        del_btn.grid(row=2,column=2,padx=6,pady=10,sticky=W)
        
        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=12,font=("verdana",12,"bold"),fg="white",bg="#003D60")
        reset_btn.grid(row=2,column=3,padx=6,pady=10,sticky=W)

        pdf_btn = Button(btn_frame, command=self.generate_pdf, text="Generate PDF", width=12, font=("verdana", 12, "bold"),fg="white", bg="#003D60")
        ...
        export_btn_right = Button(btn_frame, command=self.exportCsvRight, text="Export CSV", width=12, font=("verdana", 12, "bold"), fg="white", bg="#003D60")
