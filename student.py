...
class Student:
    ...
    # This part is image labels setting start 
        ...
        student_email_entry.grid(row=4,column=1,padx=15,pady=15,sticky=W)
        ...
        student_tutor_entry.grid(row=5,column=3,padx=15,pady=15,sticky=W)
        ...
        #save button
        save_btn=Button(btn_frame,command=self.add_data,text="Save",width=10,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        save_btn.grid(row=0,column=0,padx=8,pady=10,sticky=W)

        #update button
        update_btn=Button(btn_frame,command=self.update_data,text="Update",width=10,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        update_btn.grid(row=0,column=1,padx=8,pady=8,sticky=W)

        #delete button
        del_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=10,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        ...
        #take photo button
        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take Pic",width=9,font=("verdana",12,"bold"),fg="white",bg="navyblue", state=DISABLED)
        ...
        search_combo["values"]=("Select","LRN","Name","Grade - Section")
        ...
        generate_csv_btn = Button(search_frame, command=self.exportCsvRight, text="CSV", width=8, font=("verdana", 12, "bold"), fg="white", bg="navyblue")
